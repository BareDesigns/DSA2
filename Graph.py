...
# The next thing we need to do is determine which trucks the packages need to go into based on the time
# they are due. This will move us to the Trucks.py file.
